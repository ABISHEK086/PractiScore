...
public class ViewStaff extends AppCompatActivity {
    ...
    private StaffAdapter2 adapter;  // Updated to AdminAdapter2
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StaffAdapter2(adminList);  // Use the correct adapter here
    ...
    private void fetchAdmins() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ViewStaff.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
